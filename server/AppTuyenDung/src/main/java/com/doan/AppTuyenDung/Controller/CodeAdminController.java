...
public class CodeAdminController {
    ...
    @PostMapping("/public/create-jobLevel")
    public ResponseEntity<Map<String, Object>> handleCreateJobType(@RequestHeader("Authorization") String token, 
    ...
    @GetMapping("/public/get-all-joblevel")
    ...
    @DeleteMapping("/public/delete-joblevel")
    ...
    @PutMapping("/public/update-joblevel")
    ...
    @GetMapping("/public/get-detail-JobLevel-by-code")
    ...
    // WORK TYPE
    @PostMapping("/public/create-worktype")
    ...
    @GetMapping("/public/get-all-worktype")
    ...
    @DeleteMapping("/public/delete-worktype")
    ...
    @PutMapping("/public/update-worktype")
    ...
    @GetMapping("/public/get-detail-WorkType-by-code")
    ...
    // SALARY TYPE
    @PostMapping("/public/create-salarytype")
    public ResponseEntity<Map<String, Object>> handleCreateWorkType(@RequestHeader("Authorization") String token, 
    ...
    @GetMapping("/public/get-all-salarytype")
    ...
    @DeleteMapping("/public/delete-salarytype")
    ...
    @PutMapping("/public/update-salarytype")
    ...
    @GetMapping("/public/get-detail-SalaryType-by-code")
    ...
    // exp
    @PostMapping("/public/create-exptype")
    ...
    @GetMapping("/public/get-all-exptype")
    ...
    @DeleteMapping("/public/delete-exptype")
    ...
    @PutMapping("/public/update-exptype")
    public ResponseEntity<Map<String, Object>> handleUpdateSalaryType(@RequestHeader("Authorization") String token, 
                                                        @RequestBody CodeExpType data) 
    {
    ...
    @GetMapping("/public/get-detail-ExpType-by-code")
